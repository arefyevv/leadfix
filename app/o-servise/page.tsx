...
const limitations = [
  ...
  "часть выводов требует ручной проверки и контекста рекламы",
      ...
      <main className="seo-page">
        <section className="seo-hero">
          ...
          <p className="seo-page__lead">
            ...
            Сервис сочетает автоматическую проверку базовых сигналов и экспертный разбор там, где нужен человеческий контекст.
          </p>
        ...
        <section className="seo-section">
          ...
          <div className="seo-card-grid">
            ...
            <article className="seo-card">
              ...
              <p>Нужен там, где важно понять контекст ниши, обещание в рекламе, читаемость оффера и качество аргументации.</p>
            </article>
            <article className="seo-card">
