...
const faq = [
  [
    ...
    "Тест сайта делает базовую автоматическую проверку. Экспресс показывает полный автоматический AI-аудит. LeadFix Pro дополняется ручной экспертной проверкой."
  ],
  [
