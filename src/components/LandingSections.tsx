...
const audienceUseCases = [
  ...
  "Проверить типовые ошибки лендинга без долгого самостоятельного разбора.",
...
const faq = [
  [
    ...
    "Да. В «Старт» и «Экспресс» аудит формируется автоматически по нашей CRO-методологии. В LeadFix Pro используется более мощная AI-модель и расширенный контекст проверки."
  ],
  [
    "Можно ли гарантировать рост заявок?",
    "LeadFix не гарантирует рост заявок, а показывает слабые места посадочной страницы. Результат зависит от трафика, оффера, цены, ниши и обработки обращений."
  ],
  [
    "Когда я получу отчёт?",
    "Обычно отчёт формируется в течение нескольких минут после подтверждения оплаты. LeadFix Pro может занимать дольше, потому что использует более глубокий AI-анализ."
  ],
  [
    "Подойдёт ли для лендинга на Tilda?",
    "Да. Можно проверять лендинги на любых CMS и самописные сайты, если страница доступна по ссылке."
  ],
  [
    "Что будет в отчёте?",
    "Оценка готовности страницы, список проблем, приоритеты правок и рекомендации: что исправить сначала, чтобы снизить потери заявок."
  ],
  [
    "Можно проверить несколько страниц?",
    "Да, но каждая посадочная анализируется отдельно. Если у вас несколько лендингов, квизов или рекламных страниц, лучше проверять их по очереди."
  ],
  [
    "Это SEO-аудит или технический аудит сайта?",
    "Нет. LeadFix не про SEO-позиции и не про полный технический аудит. Фокус — конверсия лендинга и причины потери заявок."
  ]
];
    ...
    <div className="landing-flow">
      ...
      <section className="landing-section" id="pricing">
        ...
        <div className="section-head">
          ...
          <p>От быстрой бесплатной проверки до глубокого AI-аудита с расширенным планом правок</p>
        </div>
