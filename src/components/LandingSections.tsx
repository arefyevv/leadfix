...
const faq = [
  [
    ...
    "Зависит от тарифа. В «Старт» и «Экспресс» аудит формируется автоматически по нашей авторской CRO-методологии для посадочных страниц с платным трафиком. В LeadFix Pro к автоматической проверке добавляется ручная экспертная оценка."
  ],
  [
  ...
  [
    ...
    "Автоматический отчёт формируется в течение 1–3 минут. В тарифе «LeadFix Pro» ручная экспертная оценка может занять до 24 часов."
  ],
  [
