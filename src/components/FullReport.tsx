...
const auditGroups = [
  {
    title: "Смысл и предложение",
    description: "Понимает ли пользователь, что ему предлагают, для кого это и зачем ему оставлять заявку.",
  ...
  },
  {
    ...
    description: "Насколько легко, понятно и безопасно пользователю перейти от интереса к заявке.",
  ...
  },
  {
    ...
    description: "Не мешает ли сайт пользователю технически, визуально и интерфейсно.",
    items: ["Мобильная версия", "Скорость загрузки", "UX и удобство взаимодействия", "Технические ошибки"]
  },
  {
    title: "Реклама и аналитика",
    description: "Насколько лендинг готов к трафику из Яндекс Директа и можно ли измерять результат.",
