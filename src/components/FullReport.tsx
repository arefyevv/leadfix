...
const auditChecks = [
  ...
  "Боли и потребности клиента", "Аргументация выгод", "Доверие и экспертность",
  "Социальные доказательства", "Кейсы и результаты", "Призывы к действию",
  "Формы захвата", "Сценарий заявки", "Возражения клиентов",
...
const scoreRows: ScoreRow[] = [
  ...
  ["Сценарий заявки", 67, "Требует внимания", "Высокий"],
  ...
  ["Пользовательский опыт", 72, "Требует внимания", "Средний"],
