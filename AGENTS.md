...
нужен только для локальной проверки и не должен попадать в git.
...
- `LeadFix Pro` позиционируется как глубокий AI-аудит на более мощной модели, без участия человека в заявленном результате.
